...
def dcm_window_transform(x, window_center, window_width, scale=255):
...
def dcm_image_rescale(x, scale=255):
    # prove to be OK
...
def parse_args():
    ...
    cgroup.add_argument('--dicom', action='store_true',
                        help='Image type is DICOM. True or False')
    cgroup.add_argument('--window-center', type=float,
                        help='dicom window center')
    cgroup.add_argument('--window-width', type=float, default=0,
                        help='dicom image width')
